...
public class ItineraryController {
    ...
    public ResponseEntity<ResponseBasePagination<List<ItineraryDTO>>> findItinerariesWithFilter(
            @PageableDefault(sort = "crateDate", direction = Direction.DESC) final Pageable pageable,
            @RequestParam(required = false, defaultValue = "") final String filter) {
        final var response = this.itineraryService.findItinerariesWithFilter(pageable, filter);
